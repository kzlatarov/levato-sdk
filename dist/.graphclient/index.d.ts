...
export type BorrowAsPosition_orderBy = 'id' | 'position' | 'asset' | 'borrowAmount' | 'scaledATokensMinted' | 'blockNumber' | 'blockTimestamp' | 'transactionHash';
...
export type Liquidation_orderBy = 'id' | 'liquidator' | 'position' | 'borrowedAsset' | 'debtToRepay' | 'collateralAsset' | 'actualSeizedStableAmount' | 'executionPrice' | 'blockNumber' | 'blockTimestamp' | 'transactionHash';
...
export type PositionClosed_orderBy = 'id' | 'position' | 'withdrawAmount' | 'equityAmountBefore' | 'executionPrice' | 'blockNumber' | 'blockTimestamp' | 'transactionHash';
...
export type PositionFunded_orderBy = 'id' | 'position' | 'fundingAsset' | 'fundingAmount' | 'totalCollateralAmount' | 'collateralAmountFunded' | 'executionPrice' | 'blockNumber' | 'blockTimestamp' | 'transactionHash';
...
export type PositionRatioAdjusted_orderBy = 'id' | 'position' | 'targetRatio' | 'realizedRatio' | 'equityAmountBefore' | 'equityAmountAfter' | 'executionPrice' | 'blockNumber' | 'blockTimestamp' | 'transactionHash';
...
export type Position_orderBy = 'id' | 'trader' | 'collateral' | 'stable' | 'lendingProtocol' | 'fundedCollateralAmount';
export type Query = {
...
export type RepayAsPosition_orderBy = 'id' | 'position' | 'asset' | 'borrowAmount' | 'scaledATokensBurnt' | 'blockNumber' | 'blockTimestamp' | 'transactionHash';
...
export declare function getBuiltGraphSDK<TGlobalContext = any, TOperationContext = any>(globalContext?: TGlobalContext): {
    FundingQuery(variables?: Exact<{
        positionAddresses?: any;
    }> | undefined, options?: TOperationContext | undefined): Promise<FundingQueryQuery>;
    AdjustedRatioQuery(variables?: Exact<{
        positionAddresses?: any;
    }> | undefined, options?: TOperationContext | undefined): Promise<AdjustedRatioQueryQuery>;
    PositionCreatedQuery(variables?: Exact<{
        positionAddresses?: any;
    }> | undefined, options?: TOperationContext | undefined): Promise<PositionCreatedQueryQuery>;
    PositionClosedQuery(variables?: Exact<{
        positionAddresses?: any;
    }> | undefined, options?: TOperationContext | undefined): Promise<PositionClosedQueryQuery>;
    PnlQuery(variables?: Exact<{
        trader?: any;
    }> | undefined, options?: TOperationContext | undefined): Promise<PnlQueryQuery>;
};
export type FundingQueryQueryVariables = Exact<{
    positionAddresses?: InputMaybe<Array<Scalars['Bytes']> | Scalars['Bytes']>;
}>;
export type FundingQueryQuery = {
    positionFundeds: Array<Pick<PositionFunded, 'position' | 'fundingAmount' | 'fundingAsset' | 'collateralAmountFunded' | 'totalCollateralAmount' | 'executionPrice' | 'blockTimestamp' | 'blockNumber' | 'transactionHash' | 'id'>>;
};
export type AdjustedRatioQueryQueryVariables = Exact<{
    positionAddresses?: InputMaybe<Array<Scalars['Bytes']> | Scalars['Bytes']>;
}>;
export type AdjustedRatioQueryQuery = {
    positionRatioAdjusteds: Array<Pick<PositionRatioAdjusted, 'position' | 'realizedRatio' | 'equityAmountBefore' | 'equityAmountAfter' | 'executionPrice' | 'blockTimestamp' | 'blockNumber' | 'transactionHash' | 'id'>>;
};
...
export type PositionClosedQueryQuery = {
    positionCloseds: Array<Pick<PositionClosed, 'position' | 'withdrawAmount' | 'equityAmountBefore' | 'executionPrice' | 'blockTimestamp' | 'blockNumber' | 'transactionHash' | 'id'>>;
};
export type PnlQueryQueryVariables = Exact<{
    trader?: InputMaybe<Scalars['Bytes']>;
}>;
export type PnlQueryQuery = {
    positions: Array<Pick<Position, 'id' | 'collateral' | 'fundedCollateralAmount'>>;
};
export declare const FundingQueryDocument: DocumentNode<FundingQueryQuery, Exact<{
    positionAddresses?: InputMaybe<Array<Scalars['Bytes']> | Scalars['Bytes']>;
}>>;
export declare const AdjustedRatioQueryDocument: DocumentNode<AdjustedRatioQueryQuery, Exact<{
    positionAddresses?: InputMaybe<Array<Scalars['Bytes']> | Scalars['Bytes']>;
}>>;
export declare const PositionCreatedQueryDocument: DocumentNode<PositionCreatedQueryQuery, Exact<{
    positionAddresses?: InputMaybe<Array<Scalars['Bytes']> | Scalars['Bytes']>;
}>>;
export declare const PositionClosedQueryDocument: DocumentNode<PositionClosedQueryQuery, Exact<{
    positionAddresses?: InputMaybe<Array<Scalars['Bytes']> | Scalars['Bytes']>;
}>>;
export declare const PnlQueryDocument: DocumentNode<PnlQueryQuery, Exact<{
    trader?: InputMaybe<Scalars['Bytes']>;
}>>;
