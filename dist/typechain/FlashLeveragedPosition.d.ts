...
export interface FlashLeveragedPositionInterface extends Interface {
...
export interface FlashLeveragedPosition extends BaseContract {
    connect(runner?: ContractRunner | null): FlashLeveragedPosition;
    waitForDeployment(): Promise<this>;
    interface: FlashLeveragedPositionInterface;
