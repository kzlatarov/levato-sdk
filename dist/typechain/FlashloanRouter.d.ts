...
export interface FlashloanRouterInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "_listExtensions" | "_registerExtension" | "_replaceExtensions" | "acceptOwnership" | "ionicMarketOfAsset" | "owner" | "pendingOwner" | "renounceOwnership" | "transferOwnership"): FunctionFragment;
