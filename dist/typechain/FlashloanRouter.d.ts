...
export interface FlashloanRouterInterface extends Interface {
    getFunction(nameOrSignature: "_listExtensions" | "_registerExtension" | "_replaceExtensions" | "acceptOwnership" | "ionicMarketOfAsset" | "owner" | "pendingOwner" | "renounceOwnership" | "transferOwnership"): FunctionFragment;
...
export interface FlashloanRouter extends BaseContract {
    connect(runner?: ContractRunner | null): FlashloanRouter;
    waitForDeployment(): Promise<this>;
    interface: FlashloanRouterInterface;
