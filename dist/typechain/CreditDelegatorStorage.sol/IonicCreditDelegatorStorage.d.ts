...
export interface IonicCreditDelegatorStorageInterface extends utils.Interface {
    functions: {
...
export interface IonicCreditDelegatorStorage extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IonicCreditDelegatorStorageInterface;
