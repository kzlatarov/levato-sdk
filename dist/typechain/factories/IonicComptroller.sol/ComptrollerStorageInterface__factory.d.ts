...
import type { ComptrollerStorageInterface, ComptrollerStorageInterfaceInterface } from "../../IonicComptroller.sol/ComptrollerStorageInterface";
export declare class ComptrollerStorageInterface__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): ComptrollerStorageInterface;
}
