...
import type { ILendingPoolAddressesProvider, ILendingPoolAddressesProviderInterface } from "../../ILendingPool.sol/ILendingPoolAddressesProvider";
export declare class ILendingPoolAddressesProvider__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): ILendingPoolAddressesProvider;
}
