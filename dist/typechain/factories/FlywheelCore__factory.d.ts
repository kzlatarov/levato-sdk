...
export declare class FlywheelCore__factory extends ContractFactory {
    ...
    getDeployTransaction(_rewardToken: AddressLike, _flywheelRewards: AddressLike, _flywheelBooster: AddressLike, _owner: AddressLike, _authority: AddressLike, overrides?: NonPayableOverrides & {
        from?: string;
    }): Promise<ContractDeployTransaction>;
    deploy(_rewardToken: AddressLike, _flywheelRewards: AddressLike, _flywheelBooster: AddressLike, _owner: AddressLike, _authority: AddressLike, overrides?: NonPayableOverrides & {
        from?: string;
    }): Promise<FlywheelCore & {
        deploymentTransaction(): ContractTransactionResponse;
    }>;
    connect(runner: ContractRunner | null): FlywheelCore__factory;
    ...
    static connect(address: string, runner?: ContractRunner | null): FlywheelCore;
}
export {};
