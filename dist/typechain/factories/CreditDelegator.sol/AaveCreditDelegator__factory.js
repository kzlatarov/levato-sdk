...
exports.AaveCreditDelegator__factory = void 0;
...
class AaveCreditDelegator__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            super(...args);
        }
...
exports.AaveCreditDelegator__factory = AaveCreditDelegator__factory;
