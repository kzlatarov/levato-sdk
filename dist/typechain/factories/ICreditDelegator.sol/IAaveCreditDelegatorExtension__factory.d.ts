...
import type { IAaveCreditDelegatorExtension, IAaveCreditDelegatorExtensionInterface } from "../../ICreditDelegator.sol/IAaveCreditDelegatorExtension";
export declare class IAaveCreditDelegatorExtension__factory {
    ...
    static createInterface(): IAaveCreditDelegatorExtensionInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): IAaveCreditDelegatorExtension;
}
