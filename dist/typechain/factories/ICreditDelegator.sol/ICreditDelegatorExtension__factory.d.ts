...
import type { ICreditDelegatorExtension, ICreditDelegatorExtensionInterface } from "../../ICreditDelegator.sol/ICreditDelegatorExtension";
export declare class ICreditDelegatorExtension__factory {
    ...
    static createInterface(): ICreditDelegatorExtensionInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): ICreditDelegatorExtension;
}
