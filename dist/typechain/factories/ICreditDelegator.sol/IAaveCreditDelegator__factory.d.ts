...
import type { IAaveCreditDelegator, IAaveCreditDelegatorInterface } from "../../ICreditDelegator.sol/IAaveCreditDelegator";
export declare class IAaveCreditDelegator__factory {
    ...
    static createInterface(): IAaveCreditDelegatorInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): IAaveCreditDelegator;
}
