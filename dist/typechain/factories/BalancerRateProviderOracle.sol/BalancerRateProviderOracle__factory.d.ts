...
export declare class BalancerRateProviderOracle__factory extends ContractFactory {
    ...
    connect(runner: ContractRunner | null): BalancerRateProviderOracle__factory;
    ...
    static connect(address: string, runner?: ContractRunner | null): BalancerRateProviderOracle;
}
export {};
