...
import type { CreditDelegatorStorage, CreditDelegatorStorageInterface } from "../CreditDelegatorStorage";
export declare class CreditDelegatorStorage__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): CreditDelegatorStorage;
}
