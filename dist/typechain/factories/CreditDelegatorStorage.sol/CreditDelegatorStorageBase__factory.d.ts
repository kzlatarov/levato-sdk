...
import type { CreditDelegatorStorageBase, CreditDelegatorStorageBaseInterface } from "../../CreditDelegatorStorage.sol/CreditDelegatorStorageBase";
export declare class CreditDelegatorStorageBase__factory {
    ...
    static createInterface(): CreditDelegatorStorageBaseInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): CreditDelegatorStorageBase;
}
