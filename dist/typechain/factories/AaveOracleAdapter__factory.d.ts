...
export declare class AaveOracleAdapter__factory extends ContractFactory {
    ...
    getDeployTransaction(_aaveOracle: AddressLike, _wnative: AddressLike, overrides?: NonPayableOverrides & {
        from?: string;
    }): Promise<ContractDeployTransaction>;
    deploy(_aaveOracle: AddressLike, _wnative: AddressLike, overrides?: NonPayableOverrides & {
        from?: string;
    }): Promise<AaveOracleAdapter & {
        deploymentTransaction(): ContractTransactionResponse;
    }>;
    connect(runner: ContractRunner | null): AaveOracleAdapter__factory;
    ...
    static connect(address: string, runner?: ContractRunner | null): AaveOracleAdapter;
}
export {};
