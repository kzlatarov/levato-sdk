...
import type { CreditDelegator, CreditDelegatorInterface } from "../CreditDelegator";
...
export declare class CreditDelegator__factory extends ContractFactory {
    ...
    connect(runner: ContractRunner | null): CreditDelegator__factory;
    ...
    static connect(address: string, runner?: ContractRunner | null): CreditDelegator;
}
export {};
