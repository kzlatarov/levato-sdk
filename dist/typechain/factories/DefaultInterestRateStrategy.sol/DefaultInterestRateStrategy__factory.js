...
exports.DefaultInterestRateStrategy__factory = void 0;
...
class DefaultInterestRateStrategy__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            super(...args);
        }
...
exports.DefaultInterestRateStrategy__factory = DefaultInterestRateStrategy__factory;
