...
export declare class DefaultInterestRateStrategy__factory extends ContractFactory {
    ...
    connect(runner: ContractRunner | null): DefaultInterestRateStrategy__factory;
    ...
    static connect(address: string, runner?: ContractRunner | null): DefaultInterestRateStrategy;
}
export {};
