...
export interface SolidlyLpERC4626Interface extends utils.Interface {
    functions: {
        "GAUGES_FACTORY_VOTER()": FunctionFragment;
...
export interface SolidlyLpERC4626 extends BaseContract {
    ...
    functions: {
        GAUGES_FACTORY_VOTER(overrides?: CallOverrides): Promise<[string]>;
        ...
        initialize(_asset: string, _flywheel: string, _creditDelegator: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        initialize(_asset: string, _flywheel: string, _creditDelegator: string, overrides?: CallOverrides): Promise<void>;
        maxDeposit(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
        maxMint(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
        maxRedeem(owner: string, overrides?: CallOverrides): Promise<BigNumber>;
        maxWithdraw(owner: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    estimateGas: {
        GAUGES_FACTORY_VOTER(overrides?: CallOverrides): Promise<BigNumber>;
        acceptOwnership(overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        allowance(owner: string, spender: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        GAUGES_FACTORY_VOTER(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        acceptOwnership(overrides?: Overrides & {
            from?: string;
