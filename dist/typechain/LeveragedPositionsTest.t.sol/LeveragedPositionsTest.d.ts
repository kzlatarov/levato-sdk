...
export interface LeveragedPositionsTest extends BaseContract {
    connect(runner?: ContractRunner | null): LeveragedPositionsTest;
    ...
    testAllAaveLeveragedPositions: TypedContractMethod<[], [void], "nonpayable">;
    testFuzzAaveLeveragedPosition: TypedContractMethod<[
        random: BigNumberish
    ], [
        void
    ], "nonpayable">;
    testSomeAaveLeveragedPosition: TypedContractMethod<[], [void], "nonpayable">;
    testSpecificAaveLeveragedPosition: TypedContractMethod<[
    ], [
        void
    ], "nonpayable">;
    ...
    getFunction(nameOrSignature: "testAllAaveLeveragedPositions"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testFuzzAaveLeveragedPosition"): TypedContractMethod<[random: BigNumberish], [void], "nonpayable">;
    getFunction(nameOrSignature: "testSomeAaveLeveragedPosition"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testSpecificAaveLeveragedPosition"): TypedContractMethod<[], [void], "nonpayable">;
