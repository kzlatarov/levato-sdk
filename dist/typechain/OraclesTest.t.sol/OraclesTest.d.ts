...
export interface OraclesTest extends BaseContract {
    connect(runner?: ContractRunner | null): OraclesTest;
    ...
    testBalancerRateOracle: TypedContractMethod<[], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "testBalancerRateOracle"): TypedContractMethod<[], [void], "nonpayable">;
