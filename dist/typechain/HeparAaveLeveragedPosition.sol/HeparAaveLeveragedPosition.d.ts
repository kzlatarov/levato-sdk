...
export interface HeparAaveLeveragedPositionInterface extends Interface {
    getFunction(nameOrSignature: "adjustLeverageRatio" | "claimRewards()" | "claimRewards(address)" | "closePosition(address)" | "closePosition()" | "collateralAsset" | "factory" | "fundPosition" | "getAccruedRewards" | "getBorrowRate" | "getCurrentLeverageRatio" | "getEquityAmount" | "getEquityValue" | "getMaxLeverageRatio" | "getMinLeverageRatio" | "getPositionBorrowAmount" | "getPositionSupplyAmount" | "getPrice" | "getSupplyAmountDelta" | "getSupplyRate" | "isPositionClosed" | "positionOwner" | "seizeOnLiquidation" | "stableAsset" | "withdrawStableLeftovers"): FunctionFragment;
...
export interface HeparAaveLeveragedPosition extends BaseContract {
    connect(runner?: ContractRunner | null): HeparAaveLeveragedPosition;
