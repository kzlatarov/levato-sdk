...
export interface DelegatedLeveragedPositionInterface extends Interface {
...
export interface DelegatedLeveragedPosition extends BaseContract {
    connect(runner?: ContractRunner | null): DelegatedLeveragedPosition;
    waitForDeployment(): Promise<this>;
    interface: DelegatedLeveragedPositionInterface;
