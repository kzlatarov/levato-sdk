...
export interface LeveragedPositionInterface extends Interface {
...
export interface LeveragedPosition extends BaseContract {
    connect(runner?: ContractRunner | null): LeveragedPosition;
    waitForDeployment(): Promise<this>;
    interface: LeveragedPositionInterface;
