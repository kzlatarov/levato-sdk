...
export interface SolidlySwapperInterface extends Interface {
...
export interface SolidlySwapper extends BaseContract {
    connect(runner?: ContractRunner | null): SolidlySwapper;
    waitForDeployment(): Promise<this>;
    interface: SolidlySwapperInterface;
