...
export interface IFundingStrategyInterface extends Interface {
...
export interface IFundingStrategy extends BaseContract {
    connect(runner?: ContractRunner | null): IFundingStrategy;
    waitForDeployment(): Promise<this>;
    interface: IFundingStrategyInterface;
