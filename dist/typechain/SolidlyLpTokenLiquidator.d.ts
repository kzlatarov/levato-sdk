...
export interface SolidlyLpTokenLiquidatorInterface extends Interface {
...
export interface SolidlyLpTokenLiquidator extends BaseContract {
    connect(runner?: ContractRunner | null): SolidlyLpTokenLiquidator;
    waitForDeployment(): Promise<this>;
    interface: SolidlyLpTokenLiquidatorInterface;
