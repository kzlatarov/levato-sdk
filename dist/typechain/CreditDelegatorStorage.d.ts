...
export interface CreditDelegatorStorageInterface extends Interface {
    getFunction(nameOrSignature: "aaveAddressesProvider" | "acceptOwnership" | "borrowAllowance" | "borrowBalance" | "delegatedDebtAssetData" | "factory" | "owner" | "pendingOwner" | "positionBorrowIndex" | "positionBorrowIndexLastUpdate" | "positionScaledATokens" | "renounceOwnership" | "transferOwnership"): FunctionFragment;
...
export interface CreditDelegatorStorage extends BaseContract {
    connect(runner?: ContractRunner | null): CreditDelegatorStorage;
    waitForDeployment(): Promise<this>;
    interface: CreditDelegatorStorageInterface;
