...
export interface InterestRateModelsTestInterface extends Interface {
    getFunction(nameOrSignature: "IS_TEST" | "excludeArtifacts" | "excludeContracts" | "excludeSenders" | "failed" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetSelectors" | "targetSenders" | "testJumpRateModel"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "testJumpRateModel", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "testJumpRateModel", data: BytesLike): Result;
}
...
export interface InterestRateModelsTest extends BaseContract {
    connect(runner?: ContractRunner | null): InterestRateModelsTest;
    waitForDeployment(): Promise<this>;
    interface: InterestRateModelsTestInterface;
    ...
    testJumpRateModel: TypedContractMethod<[], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "testJumpRateModel"): TypedContractMethod<[], [void], "nonpayable">;
