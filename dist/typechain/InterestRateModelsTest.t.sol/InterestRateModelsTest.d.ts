...
export interface InterestRateModelsTestInterface extends utils.Interface {
    functions: {
        ...
        "testJumpRateModel()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "excludeArtifacts" | "excludeContracts" | "excludeSenders" | "failed" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetSelectors" | "targetSenders" | "testJumpRateModel"): FunctionFragment;
...
export interface InterestRateModelsTest extends BaseContract {
    ...
    functions: {
        ...
        testJumpRateModel(overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    IS_TEST(overrides?: CallOverrides): Promise<boolean>;
    ...
    callStatic: {
        ...
        targetSelectors(overrides?: CallOverrides): Promise<StdInvariant.FuzzSelectorStructOutput[]>;
        targetSenders(overrides?: CallOverrides): Promise<string[]>;
        testJumpRateModel(overrides?: CallOverrides): Promise<void>;
    };
    filters: {
