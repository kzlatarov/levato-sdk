...
export interface SolidlyERC4626TestInterface extends utils.Interface {
    functions: {
...
export interface SolidlyERC4626Test extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SolidlyERC4626TestInterface;
