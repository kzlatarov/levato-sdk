...
export interface BeefyERC4626Interface extends Interface {
    getFunction(nameOrSignature: "BPS_DENOMINATOR" | "acceptOwnership" | "allowance" | "approve" | "asset" | "balanceOf" | "balanceOfUnderlying" | "beefyVault" | "convertToAssets" | "convertToBeefyVaultShares" | "convertToShares" | "decimals" | "decreaseAllowance" | "deposit" | "emergencyWithdrawAndPause" | "feeRecipient" | "increaseAllowance" | "initialize" | "maxDeposit" | "maxMint" | "maxRedeem" | "maxWithdraw" | "mint" | "name" | "owner" | "paused" | "pendingOwner" | "performanceFee" | "previewDeposit" | "previewMint" | "previewRedeem" | "previewWithdraw" | "redeem" | "renounceOwnership" | "shutdown" | "symbol" | "takePerformanceFee" | "totalAssets" | "totalSupply" | "transfer" | "transferFrom" | "transferOwnership" | "unpause" | "updateFeeSettings" | "vaultShareHWM" | "withdraw" | "withdrawAccruedFees" | "withdrawalFee"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "convertToBeefyVaultShares", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "convertToBeefyVaultShares", data: BytesLike): Result;
...
export interface BeefyERC4626 extends BaseContract {
    connect(runner?: ContractRunner | null): BeefyERC4626;
    ...
    convertToBeefyVaultShares: TypedContractMethod<[
        shares: BigNumberish
    ], [
        bigint
    ], "view">;
    ...
    getFunction(nameOrSignature: "BPS_DENOMINATOR"): TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "beefyVault"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "convertToAssets"): TypedContractMethod<[shares: BigNumberish], [bigint], "view">;
    getFunction(nameOrSignature: "convertToBeefyVaultShares"): TypedContractMethod<[shares: BigNumberish], [bigint], "view">;
