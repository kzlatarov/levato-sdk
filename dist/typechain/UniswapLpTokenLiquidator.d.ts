...
export interface UniswapLpTokenLiquidatorInterface extends Interface {
...
export interface UniswapLpTokenLiquidator extends BaseContract {
    connect(runner?: ContractRunner | null): UniswapLpTokenLiquidator;
    waitForDeployment(): Promise<this>;
    interface: UniswapLpTokenLiquidatorInterface;
