...
export interface AaveCreditDelegatorExtensionInterface extends utils.Interface {
    functions: {
...
export interface AaveCreditDelegatorExtension extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AaveCreditDelegatorExtensionInterface;
