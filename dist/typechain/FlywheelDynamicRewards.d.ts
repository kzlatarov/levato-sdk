...
export interface FlywheelDynamicRewardsInterface extends Interface {
...
export interface FlywheelDynamicRewards extends BaseContract {
    connect(runner?: ContractRunner | null): FlywheelDynamicRewards;
    waitForDeployment(): Promise<this>;
    interface: FlywheelDynamicRewardsInterface;
