...
export interface IonicLeveragedPositionInterface extends Interface {
    getFunction(nameOrSignature: "SUPPLY_DELTA_ERROR" | "SUPPLY_DELTA_NO_ERROR" | "adjustLeverageRatio" | "claimRewards()" | "claimRewards(address)" | "closePosition(address)" | "closePosition()" | "collateralAsset" | "collateralMarket" | "factory" | "fundPosition" | "getAccruedRewards" | "getBorrowRate" | "getCurrentLeverageRatio" | "getEquityAmount" | "getEquityValue" | "getMaxLeverageRatio" | "getMinLeverageRatio" | "getPositionBorrowAmount" | "getPositionSupplyAmount" | "getPrice" | "getSupplyAmountDelta" | "getSupplyRate" | "isPositionClosed" | "pool" | "positionOwner" | "receiveFlashLoan" | "seizeOnLiquidation" | "stableAsset" | "stableMarket" | "withdrawStableLeftovers"): FunctionFragment;
...
export interface IonicLeveragedPosition extends BaseContract {
    connect(runner?: ContractRunner | null): IonicLeveragedPosition;
    ...
    collateralMarket: TypedContractMethod<[], [string], "view">;
    ...
    receiveFlashLoan: TypedContractMethod<[
        ...
        flashBorrowedAmount: BigNumberish,
    ...
    stableMarket: TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "collateralMarket"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "stableMarket"): TypedContractMethod<[], [string], "view">;
