...
export interface AaveLeveragedPositionInterface extends Interface {
...
export interface AaveLeveragedPosition extends BaseContract {
    connect(runner?: ContractRunner | null): AaveLeveragedPosition;
    waitForDeployment(): Promise<this>;
    interface: AaveLeveragedPositionInterface;
