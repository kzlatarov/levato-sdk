...
export interface CreditDelegatorInterface extends Interface {
    getFunction(nameOrSignature: "_listExtensions" | "_registerExtension" | "_replaceExtensions" | "aaveAddressesProvider" | "acceptOwnership" | "borrowAllowance" | "borrowBalance" | "delegatedDebtAssetData" | "factory" | "owner" | "pendingOwner" | "positionBorrowIndex" | "positionBorrowIndexLastUpdate" | "positionScaledATokens" | "renounceOwnership" | "transferOwnership"): FunctionFragment;
...
export interface CreditDelegator extends BaseContract {
    connect(runner?: ContractRunner | null): CreditDelegator;
