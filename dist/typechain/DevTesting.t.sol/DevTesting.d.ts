...
export interface DevTestingInterface extends Interface {
    getFunction(nameOrSignature: "IS_TEST" | "asArray(address,address,address,address,address)" | "asArray(address,address,address)" | "asArray(address,address)" | "asArray(address)" | "dai" | "delegator" | "excludeArtifacts" | "excludeContracts" | "excludeSenders" | "failed" | "irm" | "lens" | "lpf" | "maticx" | "mpo" | "proxyAdmin" | "registry" | "router" | "sammUsdrUsdc" | "stmatic" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetSelectors" | "targetSenders" | "testAccruedToTreasury" | "testCloseAllPositions" | "testCloseAndRemoveUserPosition" | "testCloseSpecificPosition" | "testCreateAaveLeveragedPosition" | "testCreateDelegatedPosition" | "testFundSpecificPosition" | "testInterestRateModel" | "testIonicLeveragedPositions" | "testLensAssetsBorrowRates" | "testLiquidateDelegatedPosition" | "testLiquidationThreshold" | "testMaxLeverageRatio" | "testModePositionsInfo" | "testPositionInfo" | "testPositionLiquidationThreshold" | "testPositionRewardsApy" | "testPositionsInfo" | "testPositionsLiquidateable" | "testRawCall" | "testRemoveSpecificPosition" | "testSolidlyLpTokenPrice" | "usdc" | "usdt" | "wbtc" | "weth" | "wmatic" | "wsteth"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "testCloseAllPositions", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "testPositionsInfo", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "testCloseAllPositions", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "testPositionsInfo", data: BytesLike): Result;
...
export interface DevTesting extends BaseContract {
    connect(runner?: ContractRunner | null): DevTesting;
    ...
    testAccruedToTreasury: TypedContractMethod<[], [void], "nonpayable">;
    testCloseAllPositions: TypedContractMethod<[], [void], "nonpayable">;
    testCloseAndRemoveUserPosition: TypedContractMethod<[], [void], "nonpayable">;
    testCloseSpecificPosition: TypedContractMethod<[], [void], "nonpayable">;
    testCreateAaveLeveragedPosition: TypedContractMethod<[
    ], [
        void
    ], "nonpayable">;
    testCreateDelegatedPosition: TypedContractMethod<[], [void], "nonpayable">;
    testFundSpecificPosition: TypedContractMethod<[], [void], "nonpayable">;
    testInterestRateModel: TypedContractMethod<[], [void], "nonpayable">;
    testIonicLeveragedPositions: TypedContractMethod<[], [void], "nonpayable">;
    testLensAssetsBorrowRates: TypedContractMethod<[], [void], "nonpayable">;
    testLiquidateDelegatedPosition: TypedContractMethod<[], [void], "nonpayable">;
    testLiquidationThreshold: TypedContractMethod<[], [void], "nonpayable">;
    testMaxLeverageRatio: TypedContractMethod<[], [void], "nonpayable">;
    testModePositionsInfo: TypedContractMethod<[], [void], "nonpayable">;
    testPositionInfo: TypedContractMethod<[], [void], "nonpayable">;
    testPositionLiquidationThreshold: TypedContractMethod<[
    ], [
        void
    ], "nonpayable">;
    testPositionRewardsApy: TypedContractMethod<[], [void], "nonpayable">;
    testPositionsInfo: TypedContractMethod<[], [void], "nonpayable">;
    testPositionsLiquidateable: TypedContractMethod<[], [void], "nonpayable">;
    testRawCall: TypedContractMethod<[], [void], "nonpayable">;
    testRemoveSpecificPosition: TypedContractMethod<[], [void], "nonpayable">;
    testSolidlyLpTokenPrice: TypedContractMethod<[], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "testAccruedToTreasury"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testCloseAllPositions"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testCloseAndRemoveUserPosition"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testCloseSpecificPosition"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testCreateAaveLeveragedPosition"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testCreateDelegatedPosition"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testFundSpecificPosition"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testInterestRateModel"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testIonicLeveragedPositions"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testLensAssetsBorrowRates"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testLiquidateDelegatedPosition"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testLiquidationThreshold"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testMaxLeverageRatio"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testModePositionsInfo"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testPositionInfo"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testPositionLiquidationThreshold"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testPositionRewardsApy"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testPositionsInfo"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testPositionsLiquidateable"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testRawCall"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testRemoveSpecificPosition"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testSolidlyLpTokenPrice"): TypedContractMethod<[], [void], "nonpayable">;
