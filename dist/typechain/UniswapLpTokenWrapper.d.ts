...
export interface UniswapLpTokenWrapperInterface extends Interface {
...
export interface UniswapLpTokenWrapper extends BaseContract {
    connect(runner?: ContractRunner | null): UniswapLpTokenWrapper;
    waitForDeployment(): Promise<this>;
    interface: UniswapLpTokenWrapperInterface;
