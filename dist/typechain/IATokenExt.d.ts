...
export interface IATokenExtInterface extends Interface {
    getFunction(nameOrSignature: "DOMAIN_SEPARATOR" | "POOL" | "RESERVE_TREASURY_ADDRESS" | "UNDERLYING_ASSET_ADDRESS" | "allowance" | "approve" | "balanceOf" | "burn" | "getPreviousIndex" | "getScaledUserBalanceAndSupply" | "handleRepayment" | "initialize" | "mint" | "mintToTreasury" | "nonces" | "permit" | "rescueTokens" | "scaledBalanceOf" | "scaledTotalSupply" | "totalSupply" | "transfer" | "transferFrom" | "transferOnLiquidation" | "transferUnderlyingTo"): FunctionFragment;
...
export interface IATokenExt extends BaseContract {
    connect(runner?: ContractRunner | null): IATokenExt;
    waitForDeployment(): Promise<this>;
    interface: IATokenExtInterface;
    ...
    POOL: TypedContractMethod<[], [string], "nonpayable">;
    ...
    getFunction(nameOrSignature: "POOL"): TypedContractMethod<[], [string], "nonpayable">;
