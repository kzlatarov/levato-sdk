...
export interface LeveragedPositionsFactoryStorageInterface extends Interface {
    getFunction(nameOrSignature: "AAVE" | "DELEGATED" | "IONIC" | "acceptOwnership" | "blocksPerYear" | "creditDelegator" | "flashloanRouter" | "fundersRegistry" | "minBorrowNative" | "oracle" | "owner" | "pendingOwner" | "renounceOwnership" | "transferOwnership"): FunctionFragment;
...
export interface LeveragedPositionsFactoryStorage extends BaseContract {
    connect(runner?: ContractRunner | null): LeveragedPositionsFactoryStorage;
