...
export declare class LeveragedPositionsFactory__factory extends ContractFactory {
    ...
    deploy(_registry: string, _flashloanRouter: string, overrides?: Overrides & {
        from?: string;
    }): Promise<LeveragedPositionsFactory>;
    getDeployTransaction(_registry: string, _flashloanRouter: string, overrides?: Overrides & {
        from?: string;
    }): TransactionRequest;
    attach(address: string): LeveragedPositionsFactory;
    connect(signer: Signer): LeveragedPositionsFactory__factory;
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): LeveragedPositionsFactory;
}
export {};
