...
import type { LevatoFlywheel, LevatoFlywheelInterface } from "../LevatoFlywheel";
type LevatoFlywheelConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;
export declare class LevatoFlywheel__factory extends ContractFactory {
    constructor(...args: LevatoFlywheelConstructorParams);
    deploy(overrides?: Overrides & {
        from?: string;
    }): Promise<LevatoFlywheel>;
    getDeployTransaction(overrides?: Overrides & {
        from?: string;
    }): TransactionRequest;
    attach(address: string): LevatoFlywheel;
    connect(signer: Signer): LevatoFlywheel__factory;
    ...
    static createInterface(): LevatoFlywheelInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): LevatoFlywheel;
}
export {};
