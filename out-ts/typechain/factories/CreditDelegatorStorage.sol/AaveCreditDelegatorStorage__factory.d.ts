...
import type { AaveCreditDelegatorStorage, AaveCreditDelegatorStorageInterface } from "../../CreditDelegatorStorage.sol/AaveCreditDelegatorStorage";
export declare class AaveCreditDelegatorStorage__factory {
    ...
    static createInterface(): AaveCreditDelegatorStorageInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): AaveCreditDelegatorStorage;
}
