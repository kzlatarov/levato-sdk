...
import type { IonicCreditDelegatorStorage, IonicCreditDelegatorStorageInterface } from "../../CreditDelegatorStorage.sol/IonicCreditDelegatorStorage";
export declare class IonicCreditDelegatorStorage__factory {
    ...
    static createInterface(): IonicCreditDelegatorStorageInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): IonicCreditDelegatorStorage;
}
