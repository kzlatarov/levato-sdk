...
import type { IATokenExt, IATokenExtInterface } from "../IATokenExt";
export declare class IATokenExt__factory {
    ...
    static createInterface(): IATokenExtInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): IATokenExt;
}
