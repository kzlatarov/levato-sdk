...
export interface AerodromeSwapperInterface extends utils.Interface {
    functions: {
...
export interface AerodromeSwapper extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AerodromeSwapperInterface;
