...
export interface LevatoERC4626Interface extends utils.Interface {
    functions: {
...
export interface LevatoERC4626 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LevatoERC4626Interface;
