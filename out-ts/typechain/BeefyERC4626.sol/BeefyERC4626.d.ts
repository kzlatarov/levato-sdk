...
export interface BeefyERC4626 extends BaseContract {
    ...
    functions: {
        ...
        convertToBeefyVaultShares(shares: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        initialize(asset: string, _beefyVault: string, _withdrawalFee: BigNumberish, _creditDelegator: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        initialize(asset: string, _beefyVault: string, _withdrawalFee: BigNumberish, _creditDelegator: string, overrides?: CallOverrides): Promise<void>;
        maxDeposit(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
        maxMint(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
        maxRedeem(owner: string, overrides?: CallOverrides): Promise<BigNumber>;
        maxWithdraw(owner: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        convertToBeefyVaultShares(shares: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
