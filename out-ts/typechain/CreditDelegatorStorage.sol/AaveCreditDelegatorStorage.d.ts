...
export interface AaveCreditDelegatorStorageInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "aaveAddressesProvider" | "acceptOwnership" | "borrowAllowance" | "borrowBalance" | "defaultRateModel" | "delegatedDebtAssetData" | "factory" | "owner" | "pendingOwner" | "positionBorrowIndex" | "positionBorrowIndexLastUpdate" | "positionScaledATokens" | "renounceOwnership" | "transferOwnership"): FunctionFragment;
...
export interface AaveCreditDelegatorStorage extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AaveCreditDelegatorStorageInterface;
