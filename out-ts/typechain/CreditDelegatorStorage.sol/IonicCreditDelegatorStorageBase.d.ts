...
export interface IonicCreditDelegatorStorageBaseInterface extends utils.Interface {
    functions: {
...
export interface IonicCreditDelegatorStorageBase extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IonicCreditDelegatorStorageBaseInterface;
