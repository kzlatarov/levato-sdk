...
export interface IRouterInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "swapExactETHForTokensSupportingFeeOnTransferTokens", values: [BigNumberish, IRouter.RouteStruct[], string, BigNumberish]): string;
...
export interface IRouter extends BaseContract {
    ...
    functions: {
        ...
        UNSAFE_swapExactTokensForTokens(amounts: BigNumberish[], routes: IRouter.RouteStruct[], to: string, deadline: BigNumberish, overrides?: Overrides & {
            from?: string;
        ...
        generateZapInParams(tokenA: string, tokenB: string, stable: boolean, _factory: string, amountInA: BigNumberish, amountInB: BigNumberish, routesA: IRouter.RouteStruct[], routesB: IRouter.RouteStruct[], overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber,
            BigNumber
        ...
        generateZapOutParams(tokenA: string, tokenB: string, stable: boolean, _factory: string, liquidity: BigNumberish, routesA: IRouter.RouteStruct[], routesB: IRouter.RouteStruct[], overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber,
            BigNumber
        ...
        swapExactETHForTokensSupportingFeeOnTransferTokens(amountOutMin: BigNumberish, routes: IRouter.RouteStruct[], to: string, deadline: BigNumberish, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        swapExactTokensForETHSupportingFeeOnTransferTokens(amountIn: BigNumberish, amountOutMin: BigNumberish, routes: IRouter.RouteStruct[], to: string, deadline: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        swapExactTokensForTokensSupportingFeeOnTransferTokens(amountIn: BigNumberish, amountOutMin: BigNumberish, routes: IRouter.RouteStruct[], to: string, deadline: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        voter(overrides?: CallOverrides): Promise<[string]>;
        weth(overrides?: CallOverrides): Promise<[string]>;
        zapIn(tokenIn: string, amountInA: BigNumberish, amountInB: BigNumberish, zapInPool: IRouter.ZapStruct, routesA: IRouter.RouteStruct[], routesB: IRouter.RouteStruct[], to: string, stake: boolean, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        zapOut(tokenOut: string, liquidity: BigNumberish, zapOutPool: IRouter.ZapStruct, routesA: IRouter.RouteStruct[], routesB: IRouter.RouteStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    ETHER(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ETHER(overrides?: CallOverrides): Promise<string>;
        UNSAFE_swapExactTokensForTokens(amounts: BigNumberish[], routes: IRouter.RouteStruct[], to: string, deadline: BigNumberish, overrides?: CallOverrides): Promise<BigNumber[]>;
        ...
        swapExactETHForTokensSupportingFeeOnTransferTokens(amountOutMin: BigNumberish, routes: IRouter.RouteStruct[], to: string, deadline: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        swapExactTokensForETHSupportingFeeOnTransferTokens(amountIn: BigNumberish, amountOutMin: BigNumberish, routes: IRouter.RouteStruct[], to: string, deadline: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        swapExactTokensForTokensSupportingFeeOnTransferTokens(amountIn: BigNumberish, amountOutMin: BigNumberish, routes: IRouter.RouteStruct[], to: string, deadline: BigNumberish, overrides?: CallOverrides): Promise<void>;
        voter(overrides?: CallOverrides): Promise<string>;
        weth(overrides?: CallOverrides): Promise<string>;
        zapIn(tokenIn: string, amountInA: BigNumberish, amountInB: BigNumberish, zapInPool: IRouter.ZapStruct, routesA: IRouter.RouteStruct[], routesB: IRouter.RouteStruct[], to: string, stake: boolean, overrides?: CallOverrides): Promise<BigNumber>;
        zapOut(tokenOut: string, liquidity: BigNumberish, zapOutPool: IRouter.ZapStruct, routesA: IRouter.RouteStruct[], routesB: IRouter.RouteStruct[], overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        ...
        generateZapInParams(tokenA: string, tokenB: string, stable: boolean, _factory: string, amountInA: BigNumberish, amountInB: BigNumberish, routesA: IRouter.RouteStruct[], routesB: IRouter.RouteStruct[], overrides?: CallOverrides): Promise<BigNumber>;
        generateZapOutParams(tokenA: string, tokenB: string, stable: boolean, _factory: string, liquidity: BigNumberish, routesA: IRouter.RouteStruct[], routesB: IRouter.RouteStruct[], overrides?: CallOverrides): Promise<BigNumber>;
        getAmountsOut(amountIn: BigNumberish, routes: IRouter.RouteStruct[], overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        generateZapInParams(tokenA: string, tokenB: string, stable: boolean, _factory: string, amountInA: BigNumberish, amountInB: BigNumberish, routesA: IRouter.RouteStruct[], routesB: IRouter.RouteStruct[], overrides?: CallOverrides): Promise<PopulatedTransaction>;
        generateZapOutParams(tokenA: string, tokenB: string, stable: boolean, _factory: string, liquidity: BigNumberish, routesA: IRouter.RouteStruct[], routesB: IRouter.RouteStruct[], overrides?: CallOverrides): Promise<PopulatedTransaction>;
