...
export interface CreditDelegatorInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "_listExtensions" | "_registerExtension" | "_replaceExtensions" | "aaveAddressesProvider" | "acceptOwnership" | "borrowAllowance" | "borrowBalance" | "delegatedDebtAssetData" | "factory" | "owner" | "pendingOwner" | "positionBorrowIndex" | "positionBorrowIndexLastUpdate" | "positionScaledATokens" | "renounceOwnership" | "transferOwnership"): FunctionFragment;
